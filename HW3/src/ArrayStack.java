...
public class ArrayStack<T> {
    ...
    public void push(T data) {
        if (data == null) {
            throw new IllegalArgumentException("Cannot push null data to the stack.");
        }
    ...
    public T pop() {
        if (size == 0) {
            throw new NoSuchElementException("Cannot pop data from an empty stack.");
        }
    ...
    public T peek() {
        if (size == 0) {
            throw new NoSuchElementException("Cannot peek data from an empty stack.");
        }
