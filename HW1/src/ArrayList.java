...
public class ArrayList<T> {
    ...
    /**
     * Resizes the backing array of the list and adds the element to the specified index.
     *
     * Resizes the backing array to a new array of the twice its initial capacity
     * and copies all of the data before the insertion index and adds the element to the specified index.
     * If there are remaining data, copies all of the data after the index.
     *
     *
     * Must be O(n).
     *
